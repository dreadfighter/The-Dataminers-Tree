...
if (challengeCompletions("e", 12) >= 9) mult = mult.mul(2)	
    ...
    11: {
        ...
        canComplete: function() {return player.points.gte(7e73)},
		unlocked() {if (inChallenge("mg", 12) || (inChallenge("i", 11))) return false
			else return hasChallenge('mg', 12)},
		goalDescription: " 7e73 Particles",
